        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-300">
              ...
              <a
                href="/Erharuyi Godwin Resume.pdf"
                download="Erharuyi Godwin Resume.pdf"
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/Godwin-Techie" },
                {
                  icon: Linkedin,
                  href: "https://www.linkedin.com/in/erharuyi996",
                },
                { icon: Twitter, href: "https://twitter.com/Device_Instereo" },
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
                ...
                <div className="absolute -bottom-4 -right-4 glass rounded-xl px-4 py-3 animate-float">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium">
                      I am Erharuyi Godwin and I am Available for work
                    </span>
                  </div>
                </div>
